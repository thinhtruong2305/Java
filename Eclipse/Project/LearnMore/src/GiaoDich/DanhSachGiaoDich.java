...
public class DanhSachGiaoDich {
	...
	public void timTheoNgayGiaoDich(int ngayGiaoDich) {
		int soLan = 1;
		for(GiaoDich giaoDich:danhSachGiaoDich) {
			if(giaoDich.getNgayGiaoDich().getDate()== ngayGiaoDich) {
				System.out.println("Giao dịch thứ "+soLan);
				System.out.println(giaoDich.toString());
				soLan++;
			}else {
	...
	public void menu() {
		...
		System.out.println("{ 13.Ghi vô file                         }");
		System.out.println("{ 14.Đọc file                            }");
	...
	public void xuLyMenu(){
		do {
			...
			case 10:
						...
						int ngay = sc.nextInt();
				this.timTheoNgayGiaoDich(ngay);nhapTiep = true;break;
			case 11:
				int maGiaoDich1 = 0;
				do {
					try {
			...
			case 13:
				...
				try {
					fos = new FileOutputStream("thinh.txt");
					for(GiaoDich giaoDich: danhSachGiaoDich) {
						String line = giaoDich.getLine();
						//chuyển string thành line
			...
			case 14:
				...
				try {
					reader = new FileReader("thinh.txt");
